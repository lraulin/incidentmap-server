/**
 * This module initializes a connection to the database using Sequelize ORM when imported,
 * and exposes methods to read to and write from the datase.
 */
...
module.exports.postgres = (() => {
  ...
  return {
    ...
    // Fetch all tweets from the database and return them as an object containing key value pairs where
    // the key is id and the value is the tweet data.
    async fetch() {
